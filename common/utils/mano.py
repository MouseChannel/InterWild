...
class MANO(object):
    def __init__(self):
        ...
        self.right_mano_layer = smplx.MANO('/home/mocheng/project/RECONSTRCUT/InterWild/common/utils/human_model_files/mano',
                                           is_rhand=True,
                                           use_pca=False,
                                           ...
                                           create_betas=False,
                                           create_transl=False)
        self.left_mano_layer = smplx.MANO('/home/mocheng/project/RECONSTRCUT/InterWild/common/utils/human_model_files/mano',
                                          is_rhand=False,
                                          use_pca=False,
                                          flat_hand_mean=False,
                                          create_global_orient=False,
        ...
        self.vertex_num = 778
        self.face = {'right': self.right_mano_layer.faces, 'left': self.left_mano_layer.faces}
        self.shape_param_dim = 10

        # fix MANO shapedirs of the left hand bug (https://github.com/vchoutas/smplx/issues/48)
        if torch.sum(torch.abs(self.left_mano_layer.shapedirs[:, 0, :] - self.right_mano_layer.shapedirs[:, 0, :])) < 1:
            print('Fix shapedirs bug of MANO')
            self.left_mano_layer.shapedirs[:, 0, :] *= -1
        ...
        self.orig_joint_regressor = self.right_mano_layer.J_regressor.numpy()  # same for the right and left hands
